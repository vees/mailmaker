...
from django.contrib.localflavor.us.models import USZipCodeField(), PhoneNumberField, USStateField
...
class Property(models.Model):
	...
	county = models.ForeignKey(County, null=False, null=False)
...
class Household(models.Model):
	...
	activated = DateField(auto_now=False, auto_now_add=False)
	last_renewal = DateField(auto_now=False, auto_now_add=False)
